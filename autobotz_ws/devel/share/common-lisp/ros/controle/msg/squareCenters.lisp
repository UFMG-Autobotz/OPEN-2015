...
(cl:defmethod cl:initialize-instance :after ((m <squareCenters>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'squareCenters)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name controle-msg:<squareCenters> is deprecated: use controle-msg:squareCenters instead.")))

(cl:ensure-generic-function 'centers-val :lambda-list '(m))
(cl:defmethod centers-val ((m <squareCenters>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader controle-msg:centers-val is deprecated.  Use controle-msg:centers instead.")
  (centers m))
