...
(cl:defmethod cl:initialize-instance :after ((m <squareCenters>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'squareCenters)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name square_detect-msg:<squareCenters> is deprecated: use square_detect-msg:squareCenters instead.")))

(cl:ensure-generic-function 'centers-val :lambda-list '(m))
(cl:defmethod centers-val ((m <squareCenters>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader square_detect-msg:centers-val is deprecated.  Use square_detect-msg:centers instead.")
  (centers m))
