...
//ros::Publisher chatterD("/eletronica/ultrassom/raw/R", &distanciaD);
//ros::Publisher chatterE("/eletronica/ultrassom/raw/L", &distanciaE);
ros::Publisher chatterF("/eletronica/ultrassom/raw/F", &distanciaF);
//ros::Publisher chatterT("/eletronica/ultrassom/raw/B", &distanciaT);
...
void loop()
{
 ...
 for(num_Ultrassonico=2; num_Ultrassonico<3; num_Ultrassonico++){ 
